...
api_key = 'AIzaSyD_JMXBBNXI_WjrYzaVdSt6U1nnQxLQhnc'
...
class RealSpider(scrapy.Spider):
    ...
    start_urls = ["http://www.realestate.com.au/buy/in-cannon+hill%2c+qld+4170/list-2?includeSurrounding=false",
    ...
    def parse_attr(self, response):
        ...
        # This part below should get the Geocode of the property
        try:
            geocode_result = gm.geocode(street + suburb + state)[0]
        except:
            geocode_result = 0
        try:
